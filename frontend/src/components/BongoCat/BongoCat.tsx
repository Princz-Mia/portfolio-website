...
const BongoCat = () => {
  ...
  const shakeAnimation = () => {
    ...
    // Define a selector for the parts that should shake
    // (the head and the headphone speakers)
    const shakeSelectors =
      ".head, .headphone-left .speaker, .headphone-right .speaker";

    // Animate these parts simultaneously
  ...
  useEffect(() => {
    ...
    const noteEls: HTMLElement[] = noteElFn(
